...
public class DocumentFragment extends Fragment {
    ...
    TextView noData;
    String path = (Environment.getExternalStorageDirectory().toString() + "/Document Scanner/Document");
    int pos;
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        this.rvCreation = (RecyclerView) viewGroup2.findViewById(R.id.rvDocCreation);
       ...
       ItemClickSupport.addTo(this.rvCreation).setOnItemClickListener(new ItemClickSupport.OnItemClickListener() {
            public void onItemClicked(RecyclerView recyclerView, int i, View view) {
                DocumentFragment.this.pos = i;
                if (DocumentFragment.this == null) {
                    Intent intent = new Intent(DocumentFragment.this.getActivity(), Camera_Scanner_CreationListActivity.class);
                    intent.putExtra("folderPath", DocumentFragment.this.creationParentModels.get(i).getFolderPath());
                    DocumentFragment.this.startActivity(intent);
                } else {
                    Intent intent2 = new Intent(DocumentFragment.this.getActivity(), Camera_Scanner_CreationListActivity.class);
                    intent2.putExtra("folderPath", DocumentFragment.this.creationParentModels.get(i).getFolderPath());
