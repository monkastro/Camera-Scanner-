...
public class BookFragment extends Fragment {
    ...
    TextView noData;
    String path = (Environment.getExternalStorageDirectory().toString() + "/Document Scanner/Book");
    int pos;
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        this.rvCreation = (RecyclerView) viewGroup2.findViewById(R.id.rvBookCreation);
       ...
       ItemClickSupport.addTo(this.rvCreation).setOnItemClickListener(new ItemClickSupport.OnItemClickListener() {
            public void onItemClicked(RecyclerView recyclerView, int i, View view) {
                BookFragment.this.pos = i;
                if (BookFragment.this == null) {
                    Intent intent = new Intent(BookFragment.this.getActivity(), Camera_Scanner_CreationListActivity.class);
                    intent.putExtra("folderPath", BookFragment.this.creationParentModels.get(i).getFolderPath());
                    BookFragment.this.startActivity(intent);
                } else {
                    Intent intent2 = new Intent(BookFragment.this.getActivity(), Camera_Scanner_CreationListActivity.class);
                    intent2.putExtra("folderPath", BookFragment.this.creationParentModels.get(i).getFolderPath());
